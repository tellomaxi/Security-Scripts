...
def main():
    ...
    print("0- The HackerNews")
    print("1- ThreatPost")
    print("2- NakedSecurity")

    website_list = ("https://feeds.feedburner.com/TheHackersNews", "https://threatpost.com/feed", "https://nakedsecurity.sophos.com/")

    website_input = int(input("Enter website numbre: "))
